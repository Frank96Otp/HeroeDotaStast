...
class Favorites_Heroes_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_favorites__heroes_, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment Favorites_Heroes_Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Favorites_Heroes_Fragment().apply {
